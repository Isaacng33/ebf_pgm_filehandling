...
EXES=(ebfEcho ebfComp ebuEcho ebuComp ebcEcho ebcComp ebf2ebu ebu2ebf ebc2ebu ebu2ebc)
...
do
    ...
    # Dont need to run these test as ebc is compressed and can't have bad data
